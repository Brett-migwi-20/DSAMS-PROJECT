          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              <h2 className="font-semibold text-4xl text-blueGray-600">
                DSAMS - Smart Agriculture
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                DSAMS is a software application that helps farmers manage and
              ...
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-blueGray-700">
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  <h4 className="text-xl font-bold text-white">
                    DSAMS - The Farming Assistant
                  </h4>
                  <p className="text-md font-light mt-2 text-white">
                    DSAMS is a software application that helps farmers manage
                  ...
                  <div className="relative flex flex-col mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        DSAMS allows you to identify dangerous crop diseases
                  ...
                  <div className="relative flex flex-col min-w-0 mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        ...
                        nutrients. Know the right amount from DSAMS.
                      </p>
                    </div>
                  </div>
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        ...
                        weather with predictions from DSAMS.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              ...
              <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                DSAMS allows you to identify dangerous crop diseases and apply
